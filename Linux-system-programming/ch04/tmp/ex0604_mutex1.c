//참조: http://terminus.pe.kr/doc/thread/multi-thread.html
//원본: http://users.actcom.co.il/~choo/lupg/tutorials/multi-thread/multi-thread.html 
//mutex 사용
...
//PTHREAD_MUTEX_INITIALIZER (한번만 사용)
